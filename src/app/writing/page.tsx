...
import { listLessons } from "@/lib/writing/queries";
import { MODULES } from "@/lib/modules";

export default async function WritingPage() {
  const mod = MODULES.find((m) => m.slug === "writing")!;
  const Icon = mod.icon;
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6">
      <div className="text-center">
        ...
        <h1 className="mt-4 text-3xl font-extrabold tracking-tight text-slate-900">Writing</h1>
        <p className="mt-2 text-slate-500">Pick a lesson to start practicing.</p>
      </div>
